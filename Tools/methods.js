let Methods = (function () {
  return {
    ...
    cookieUse(type, data, name, time = 1) {
      switch (type) {
        case "add":
          ...
          document.cookie =
            name + "=" + JSON.stringify(data) + ";expires=" + date.toString();
          break;
        case "del":
      ...
      GetArea.prototype = {
        ...
        loadHandler(e) {
          ...
          this.self.createOptions(
            this.self.list,
            this.self.selections[this.self.num]
          );
        },
        changeHandler(e) {
          var list;
    ...
    fetchBlobUrl: async ({
      ...
      const blobRes =
        res.status !== 200 ? await res.json() : await res.arrayBuffer();
